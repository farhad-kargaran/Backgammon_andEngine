...
public class SecurePreferences implements SharedPreferences {
    ...
    */
    ...
    private static final String TAG = "rrn SecurePreferences";
	...
	public static class Editor implements SharedPreferences.Editor
	{
		...
		{
			mEditor.putString(SecurePreferences.hashPrefKey(key),SecurePreferences.encrypt(value));
			return this;
		}
		...
		{
			mEditor.putString(SecurePreferences.hashPrefKey(key),SecurePreferences.encrypt(Integer.toString(value)));
			return this;
		}
		...
		{
			mEditor.putString(SecurePreferences.hashPrefKey(key),SecurePreferences.encrypt(Long.toString(value)));
			return this;
		}
		...
		{
			mEditor.putString(SecurePreferences.hashPrefKey(key),SecurePreferences.encrypt(Float.toString(value)));
			return this;
		}
		...
		{
			mEditor.putString(SecurePreferences.hashPrefKey(key),SecurePreferences.encrypt(Boolean.toString(value)));
			return this;
		}
